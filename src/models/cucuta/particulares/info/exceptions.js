module.exports = `Exceptúense de la medida del Pico y Placa los siguientes vehículos:<ul>
        ...
        <li>Vehículos oficiales al servicio del Ministerio Público: Procurador Regional y Procuradores Provinciales, y Defensor del Pueblo.</li>
        <li>Vehículos oficiales: gerentes departamentales de la Contraloría de la República, Contralor Departamental del Norte de Santander, Contralor Municipal de Cúcuta, Personero Municipal de Cúcuta, Magistrados de los Tribunales de Cúcuta, Jueces y Fiscales, Concejales del Municipio de Cúcuta, Diputados del Departamento Norte de Santander.</li>
